...
# Option+Shift+0-9 will be used to switch sessions
...
for i in {0..9}; do
  log_info "Creating keybinding profile for Session $i (Option+Shift+$i)..."
...
log_info "   - Set hotkey to Option+Shift+<number>"
...
log_info "2. In Profiles → Keybindings, map Option+Shift+0-9 to each"
log_info ""
